...
public class ControllerAdvisor extends ResponseEntityExceptionHandler  {
	...
	public ResponseEntity<CustomResponse> handleInvalidProductException(InvalidProductException ex, WebRequest req){
		return new ResponseEntity<CustomResponse>(new CustomResponse(ex.getStatus(),ex.getMessage()), HttpStatus.BAD_REQUEST);
	}
	
	@ExceptionHandler(CustomException.class)
	public ResponseEntity<CustomResponse> handleException(CustomException ex){
	    return new ResponseEntity<CustomResponse>(new CustomResponse(ex.getStatus(),ex.getMessage()), HttpStatus.BAD_REQUEST);
	}
